...
const FAQS = [
  {
    ...
    ar_a: 'المسابقة مفتوحة لطلاب المرحلة الإعدادية والثانوية والبكالوريوس من أي مكان في العالم. يجب على المشاركين تشكيل فرق من 1–3 طلاب.',
  },
  {
    ...
    ar_a: 'لا، المسابقة مجانية تمامًا لضمان تكافؤ الفرص لجميع الطلاب.',
  },
  {
    ...
    ar_a: 'تغطي المسابقة الفيزياء حصريًا. تتدرج الأسئلة في الصعوبة عبر الجولات الأربع.',
  },
  {
    ...
    ar_a: 'تتميز المسابقة بتحديات فيزياء قصصية مدمجة في سرد مغامرة مصرية. تتكون المسابقة من أربع جولات.',
  },
  {
    ...
    ar_a: 'ستحتاج إلى جهاز كمبيوتر متصل بالإنترنت للمشاركة في المسابقة الافتراضية.',
  },
  {
    ...
    ar_a: 'يتم تحديد الفائزين بناءً على الأداء في الجولات الأربع. تُتوَّج أفضل ثلاث فرق في الجولة النهائية.',
  },
  {
    ...
    ar_a: 'نعم! يمكن أن تتكون الفرق من 1 إلى 3 مشاركين. يمكنك التسجيل كمتسابق فردي.',
  },
  {
    ...
    ar_a: 'نعم، تُعقد جميع الجولات عبر الإنترنت بالكامل. لا يلزم السفر.',
  },
];
